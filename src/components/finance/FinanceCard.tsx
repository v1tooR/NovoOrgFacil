...
import { MoreHorizontal, Pencil, Trash2, TrendingUp, TrendingDown, CheckCircle2, CreditCard, Landmark, Loader2, Repeat, Repeat2 } from 'lucide-react'
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-0.5 flex flex-wrap items-center gap-x-2 gap-y-0.5">
            ...
            {entry.import_source === 'ofx' && (
              <span className="inline-flex items-center gap-1 rounded-full border px-1.5 py-0.5 text-[10px] font-medium text-muted-foreground">
                <Landmark className="h-3 w-3" />Extrato
              </span>
            )}
